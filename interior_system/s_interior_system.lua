--[[
* ***********************************************************************************************************************
* Copyright (c) 2025 Kuzenler Roleplay - All Rights Reserved
* All rights reserved. This program and the accompanying materials are private property belongs to Kuzenler Roleplay
...
function publicSellProperty(thePlayer, dbid, showmessages, givemoney, CLEANUP)
	...
	if query then
		...
		outputChatBox("Error 504914 - Report on bugs.kuzenlergaming.net", thePlayer, 255, 0, 0)
	end
end
